...
`/municipios/cobertura.html` muestra los faltantes de los 135 municipios, con descarga CSV, períodos y estado de revisión del portal. El comparador de Recursos usa IPC nacional para elegir pesos corrientes o precios de diciembre de 2024, diciembre de 2025 y julio de 2026. Incluye calculadora y CSV. Los flujos fiscales sin apertura mensual conservan pesos corrientes. Regenerar estos recursos con `python scripts_build_municipal_tools.py`; CI verifica que correspondan a la base y al IPC. El CSV municipal también incluye población, sectores, salarios, actividad, bancos, salud, vivienda, delitos y deuda personal.
...
La base de esta versión proviene de la investigación auditada del 7 de septiembre de 2026. Transferencias: 2025 y enero–julio 2026; empleo: 2019–2025; población y NBI: Censo 2022; producto municipal: 2021–2023; bancos: 2024. Cuentas individuales: 91 municipios, con 73 comparables a junio de 2026 y 18 con otros períodos. Tigre integra la muestra después de conciliar su clasificación económica y programática. General Las Heras y Tigre incluyen historia fiscal desde 2021, presupuesto, pagos, tesorería y el alcance de los pasivos disponibles. Transparencia: puntajes ASAP de los 135 municipios para noviembre de 2025 y mayo de 2026, con sus seis componentes y fechas de relevamiento. `municipios/metodologia.html` documenta definiciones, diferencias de cobertura y enlaces; `municipios/data/build-manifest.json` conserva las huellas de los CSV de entrada.
...
La ampliación de los dos distritos se reproduce con `scripts_import_municipal_management.py --input-dir /ruta/municipal-deep-20260909` (PyMuPDF, openpyxl y xlrd). El registro `municipios/data/management_verified.json` conserva 26 documentos primarios, fechas, huellas, importes exactos y la conciliación con CAIF 2025. El generador de tablero valida períodos, sumas, objetos y cobros. Ver `docs/auditoria_las_heras_tigre_2026-09-09.md`.
La ampliación BCRA concilia los agregados bancarios originales 2023-2024 y agrega diciembre de 2025 y junio de 2026 para Tigre. Las Heras preserva valores no publicados; los ceros del archivo bruto no se convierten en observaciones.
