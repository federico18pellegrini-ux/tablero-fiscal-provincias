...
def main() -> None:
    ...
    payload = {
        ...
        "risks": [
            {
                "title": "El gasto anual supera a los ingresos",
                "evidence": "En 12 meses se gastaron $106,60 por cada $100 ingresados: faltaron $2,70 antes de intereses y los intereses consumieron otros $3,80.",
