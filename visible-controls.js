...
function initVisibleControls(){
 ...
 const municipalLink=document.createElement('a');municipalLink.href='municipios/';municipalLink.className='municipal-dashboard-link';municipalLink.textContent='Municipios PBA ↗';section.lastElementChild.append(municipalLink);
