...
function initVisibleControls(){
 ...
 const municipalLink=document.createElement('a');municipalLink.href='municipios/';municipalLink.className='municipal-dashboard-link';municipalLink.setAttribute('aria-label','Ir al tablero municipal de Buenos Aires');municipalLink.innerHTML='Municipios <span aria-hidden="true">↔</span>';section.firstElementChild.append(municipalLink);
