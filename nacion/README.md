...
- 374 cruces con PA 2026: 356 por nombre normalizado, entidad y jurisdicción, más 18 por códigos y fascículos oficiales. Las 20 restantes (0,33% del proyecto) quedan sin comparación. Los originales, sus huellas y cada equivalencia están en `data/program-sources/crosswalk.json`; se verifica código, nombre e importe del proyecto y una única base 2026 por fila. Las coincidencias ambiguas se rechazan. No se trasladan funciones 2026 a programas 2027.
