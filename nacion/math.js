(function(root){
  ...
  const anchorPages = Object.freeze({prioridades:'prioridades',normas:'actos',carteras:'carteras','politica-jubilaciones':'politicas','politica-alimentacion':'politicas','politica-medicamentos':'politicas','politica-seguridad-federal':'politicas',inicio:'panorama',escala:'panorama',historia:'panorama',distribucion:'gasto',comparacion:'gasto',cambios:'gasto',programas:'gasto',finalidades:'gasto',obras:'obras',recursos:'economia',macro:'economia',financiamiento:'economia',escenarios:'economia','obra-ra10':'obra-ficha','politica-inmunizaciones':'politicas','politica-educacion-superior':'politicas',ejecucion:'ejecucion',modificaciones:'ejecucion',caja:'ejecucion','deuda-nacional':'ejecucion','provincias-nacion':'ejecucion',metas:'ejecucion','obras-ejecucion':'ejecucion','historia-ejecucion':'ejecucion',metodo:'metodo'});
