(function(root){
  ...
  const anchorPages = Object.freeze({inicio:'panorama',escala:'panorama',historia:'panorama',distribucion:'gasto',comparacion:'gasto',cambios:'gasto',programas:'gasto',finalidades:'gasto',obras:'obras',recursos:'economia',macro:'economia',financiamiento:'economia','politica-inmunizaciones':'politicas','politica-educacion-superior':'politicas',ejecucion:'ejecucion',caja:'ejecucion','deuda-nacional':'ejecucion','provincias-nacion':'ejecucion',metas:'ejecucion','obras-ejecucion':'ejecucion','historia-ejecucion':'ejecucion',metodo:'metodo'});
