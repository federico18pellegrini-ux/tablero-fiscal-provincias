...
| P1 | El proxy de “aporte a la masa nacional” usaba participación en recaudación propia provincial 2026 con cobertura mensual desigual. | No mide aporte a la masa federal y podía inducir un “retorno por cada 100” inválido. | Reemplazado por la estimación oficial PBA 2025: 38% generado en la Provincia frente a recursos automáticos auditados; se identifica expresamente como estimación. |
