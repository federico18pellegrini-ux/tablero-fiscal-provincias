...
Se solicitan copias de los formularios F.3 y F.3 Bis presentados por los organismos durante la formulación 2027 y sus modificaciones, junto con los anexos de gastos o registros que identifiquen las actividades trasladadas. Para cada origen y destino, interesa contar con jurisdicción, subjurisdicción, entidad o SAF, programa, subprograma, proyecto, actividad, obra y unidad ejecutora. Cuando corresponda, incluir código BAPIN y número de préstamo.

Para reconstruir los importes, se requiere el crédito inicial, crédito vigente y gasto devengado de 2026, con fecha de corte, y el monto del proyecto 2027 correspondiente al mismo conjunto de actividades. Resulta especialmente útil una apertura por inciso y fuente de financiamiento. Si una función se distribuye entre varias partidas, indicar el importe asignado a cada destino y el documento que respalda la distribución. Si no existe una tabla consolidada, sirven los archivos y actos administrativos originales que permitan reconstruirla.

Los casos son:

1. **Vocería Presidencial y Comunicación y Medios.** Distribución de los créditos y gastos del programa 16 de Comunicación y Prensa (2026, jurisdicción 25, SAF 368) entre los programas 50 y 16 de Presidencia en 2027, incluyendo incorporaciones desde otras áreas previstas por los Decretos 581/2026 y 658/2026.
2. **Actividades comunes de Turismo, Ambiente y Deporte.** Identificación del gasto de apoyo a Deportes incorporado al programa común 4 de Jefatura en 2027, su origen 2026 y su relación con el programa común 11 de Deportes. Origen principal a revisar: jurisdicción 25, SAF 322, programa 4; y jurisdicción 30, SAF 325, programa 11.
...
El objetivo es separar las modificaciones reales de gasto de los cambios de organización, sin duplicar recursos ni presentar una nueva clasificación como una política nueva.
