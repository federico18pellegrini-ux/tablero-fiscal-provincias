...
| Rigidez salarial 50,5% | `dashboard_cross_section_fiscal.json` + visualización `index.html` | Valor sensible sin etiqueta de corte metodológico explícita (riesgo de leerse como “actual 2026”) | fuente / etiqueta | Se mantuvo el valor como dato estructural 3T2025 y se reforzó el alcance por módulo en notas de universo/temporalidad. |
