...
function renderProvinceServices(province){
 ...
 document.getElementById('debtScheduleReading').textContent=projection?'El calendario muestra lo previsto según esa publicación. No permite saber cuánto queda por pagar hoy: hay que descontar pagos e incorporar refinanciaciones y nueva deuda.':coverage?.schedule_note||'No hay calendario cargado.';
 ...
 document.getElementById('debtDecisionGap').textContent='Para decidir si la plata alcanza hay que juntar el calendario de pagos con la caja que se puede usar, salarios, aguinaldo y financiamiento disponible.';
