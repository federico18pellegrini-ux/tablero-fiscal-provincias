...
class EditorialReport(Report):
    ...
    def core_overview(self):
        ...
        concentration=(f"{escaped(largest['name'])} concentra el {number(ratio(largest['jobs'],m['empleo_dic2025']),1)}% de los puestos registrados. " if largest and m['empleo_dic2025']>0 else '')
