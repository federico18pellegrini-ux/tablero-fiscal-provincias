...
function renderEmployment(){
  ...
  $('salary-panel').innerHTML=`<div class="eyebrow">Entender el dato</div><h2>El salario publicado es bruto y promedio</h2><div class="stats-grid">${card('Promedio mensual de 2025',money(wage.annual['2025'].nominal),'Bruto · en los pesos de cada mes de 2025')}${card('El mismo promedio, ajustado por inflación',money(wage.annual['2025'].real),'Bruto · a precios de julio de 2026')}${card('Diciembre de 2025',money(wage.months['2025-12'].nominal),'Bruto · pesos de diciembre · incluye pagos estacionales')}</div><p>El OEDE calcula la remuneración bruta promedio que las empresas privadas declaran al SIPA, a través de ARCA. Incluye aguinaldo, conceptos no remunerativos y pagos por vacaciones. <strong>No es el sueldo de bolsillo</strong>: todavía no se descontaron aportes ni otras deducciones.</p><p>Por ejemplo, en noviembre de 2025 el promedio bruto fue de ${money(wage.months['2025-11'].nominal)}, frente a ${money(wage.months['2025-12'].nominal)} en diciembre. El aguinaldo y otros pagos pueden elevar el cierre del año. Noviembre tampoco representa necesariamente el sueldo habitual de cada trabajador.</p><p>El promedio corresponde a puestos en establecimientos del municipio, cuyos trabajadores pueden vivir en otro lugar. Los salarios altos y el peso de cada sector pueden moverlo: no describe al vecino típico ni es la mediana.</p><p class="chart-caption">Real significa ajustado por inflación. Para calcularlo multiplicamos cada salario mensual por IPC de julio de 2026 / IPC del mes y después promediamos los doce meses. El IPC es el índice de precios al consumidor del INDEC. Se verificaron los 84 meses por municipio contra las planillas originales.</p><p class="data-sources">Datos: <a href="https://www.argentina.gob.ar/sites/default/files/departamento_serie_empleo_remuneraciones_3.xlsx" target="_blank" rel="noopener">OEDE / SIPA, empleo y remuneraciones</a> · <a href="https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_08_26.xls" target="_blank" rel="noopener">INDEC, IPC nacional</a></p><h3>Producto bruto municipal: qué produce el territorio</h3><p>La Dirección Provincial de Estadística estima el valor de los bienes y servicios generados en el municipio, evitando contar dos veces los insumos. Es actividad económica, no recaudación ni presupuesto municipal. Entre 2021 y 2023 varió <span class="${negativeClass(m.pbg_real_cambio_2021_2023_pct)}">${pct(m.pbg_real_cambio_2021_2023_pct)}</span>, a precios constantes de 2004, es decir, sin el efecto de la inflación. El último año incorporado es 2023.</p><p class="data-sources"><a href="metodologia.html#actividad">Ver el origen del producto municipal</a></p><h3>Endeudamiento de las familias</h3><p>Las bases abiertas del BCRA revisadas informan personas con crédito por provincia. No encontramos una serie municipal comparable de deuda familiar o mora, es decir, atrasos en los pagos. Los préstamos bancarios asignados a una localidad incluyen otros usos y no identifican exclusivamente a sus hogares.</p><p class="data-sources"><a href="https://www.bcra.gob.ar/indicadores-inclusion-financiera/" target="_blank" rel="noopener">BCRA, indicadores de inclusión financiera</a></p>`;
