...
export const METRICS = [
  ...
  metric('deficit', 'Resultado sobre ingresos', 'Cuentas', 'fiscal.resultado_sobre_ingresos_pct', '%', 'Acumulado al 30 de junio de 2026', 'Muestra parcial de 3 municipios. Negativo: déficit; positivo: superávit. Recursos percibidos y gastos devengados. No es caja libre.'),
  metric('resultado-pesos', 'Resultado en pesos', 'Cuentas', 'fiscal.resultado_financiero', 'millions', 'Acumulado al 30 de junio de 2026', 'Resultado financiero de 3 municipios, en pesos corrientes. No permite identificar el mayor déficit de los 135.'),
  metric('inversion', 'Inversión sobre gasto', 'Cuentas', 'fiscal.capital_sobre_gasto_pct', '%', 'Acumulado al 30 de junio de 2026', 'Gasto de capital sobre gasto total sin aplicaciones financieras. Muestra de 3; no mide calidad de las obras.', false)
];
