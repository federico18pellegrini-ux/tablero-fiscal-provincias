...
function rankingAssessment(meta, value) {
...
const VALID_VIEWS = ['panorama', 'rankings', 'recursos', 'empleo', 'simular', 'informe'];
const BUDGET_BASES = {
...
function annualBudgetExportRows(m) {
...
const REPORT_TOPICS=['lectura','cuentas','economia','poblacion','deudas','detalle-fiscal','caja','historia','bancos'];
const DEFAULT_REPORT_TOPICS=['lectura','cuentas','economia'];
...
function reportSelection(entry,topics=DEFAULT_REPORT_TOPICS){
...
async function composeMunicipalPdf(bytes,entry,topics,pdfLib){
